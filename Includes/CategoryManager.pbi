...
XIncludeFile "UUID4Struct.pbi"

; TODO: Make this a generic Tree list structure?
; TODO: Change UUID4 struct to just a UUID4 buffer
...
Procedure CreateCategory(Id$, *Parent.Category = #Null)
	If Id$
		...
		If *Category
			*Category\Id$ = Id$
			*Category\UUID4 = GenerateUUID4Structure()
			...
			If *Category\UUID4
				If *Parent <> #Null
					...
					Else
						FreeUUID4Struct(*Category\UUID4)
